<%-- 
    Document   : ResultatCoupure
    Created on : 11 déc. 2023, 19:14:52
    Author     : Tohy
--%>
...
<html>
    <head>
        ...
        <title>Gestion Solaire - Resultat Coupure</title>
        <!-- Simple bar CSS -->
    ...
    <body class="vertical  light  ">
        ...
        <main role="main" class="main-content">
            ...
            <div class="row justify-content-center">
                <div class="col-8">
                <h2 class="page-title text-center">Resultat de coupure</h2>
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <p><strong>Date : </strong><%=coupure.getDate() %></p>
                                <p><strong>Heure Coupure entrer : </strong><%=coupure.getHeure() %></p>
                                <p><strong>Consommation calculer : </strong><%=coupure.getPuissance_etudiant() %></p>
                                <p><strong>Heure Coupure exacte : </strong><%=coupure.getHeureResultat() %></p>
                            </div>
                        </div>
                    </div>
                </div>
